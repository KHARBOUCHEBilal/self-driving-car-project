...
#### STEP 7 - CREATE MODEL
### Ce modèle contient un total de 5 couches de convolution suivies de 4 couches denses (fully connected).
# En comptant également la couche d'entrée, cela fait 9 couches au total.
def createModel():
  model = Sequential()
